...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 font-weight-semibold"><i class="bi bi-buildings-fill"></i>{{ __(' Item Details') }}</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                     {{-- Success Alert --}}
                            @if(session('success'))
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <form method="GET" action="{{ route('item') }}" class="form-inline">
                                        ...
                                        <tbody>
                                            @foreach($items as $item)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <!-- Edit Button -->
                                                        <a href="{{ route('item.edit', $item->id) }}"  class="btn btn-sm btn-warning"><i class="bi bi-pencil-square"></i></a>
                                                        <!-- view Button -->
                                                        <a href="{{ route('item.view', $item->id) }}"  class="btn btn-sm btn-secondary"><i class="bi bi-eye-fill"></i></a>
                                                        <!-- Delete Button -->
                                                        <a href="{{ route('item.delete', $item->id) }}"  class="btn btn-sm btn-danger"><i class="bi bi-trash3-fill"></i></a>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
