...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 font-weight-semibold"><i class="bi bi-star-fill"></i>{{ __(' View Category') }}</h1>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $category->active ? __('Active') : __('Deactive') }}" readonly>
                            </div>
                            <div class="form-group">
                            ...
                            <a href="{{ route('category') }}" class="btn btn-primary">{{ __('Back') }}</a>
                        </div>
                    </div>
                </div>
            </div>
